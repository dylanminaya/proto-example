Aquí vamos a hacer el esquema del API Gateway utilizando gRPC y vamos a tomar un approach proto-centric

Esto significa que vamos a definir cosas en formato de protobuf (literalmente archivos .proto) y esto va a generar los types en TypeScript (para frontend) y en Rust (para backend)

ejemplito frontend/backend de este proto file:
...
Goal for this backend is to be able to:

- Genérame un crate con tonic que responda a este proto file
- So I can use it in my frontend's login and register pages